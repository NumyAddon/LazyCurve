...
--- @class LazyCurve: AceAddon, AceConsole-3.0, AceHook-3.0, NumyAceEvent-3.0
local LazyCurve = LibStub('AceAddon-3.0'):NewAddon(name, 'AceConsole-3.0', 'AceHook-3.0', 'NumyAceEvent-3.0');
