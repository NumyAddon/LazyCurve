...
if not isDF then return; end -- DF only
--- @todo delete file in TWW
...
function SearchEntryMenuUtil:GetSearchEntryMenu(resultID)
...
function SearchEntryMenuUtil:FormatAchievementMenuItem(achievementId, leaderName)
...
function SearchEntryMenuUtil:GetAchievementMenu(infoTable, leaderName)
    local mainMenuItems = {}
...
function SearchEntryMenuUtil:getExtraMenuList(groupId, leaderName)
